                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: <Widget>[
                                                      Column(
                                                        ...
                                                        children: <Widget>[
                                                          Text("Order No. "+data[index].orderId,style: TextStyle(fontFamily:'NunitoSans',fontSize:14,color:orderHeaderColor, fontWeight:FontWeight.bold)),
                                                          Text("No. of Items: "+data[index].items.length.toString(),style: TextStyle(fontFamily:'NunitoSans',fontSize:11,color:Colors.grey, fontWeight:FontWeight.bold)),
                                                        ],
                                                      ),
                                                      Column(
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: <Widget>[
                                                          Text("Order Date",style: TextStyle(fontFamily:'NunitoSans',fontSize:14,color:orderHeaderColor, fontWeight:FontWeight.bold)),
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                                          ...
                                                                          actions: <Widget>[
                                                                            ...
                                                                            CupertinoDialogAction(
                                                                              ...
                                                                              onPressed: () async{
                                                                                ...
                                                                                FormData formData = new FormData.fromMap({
                                                                                  "user_id": userId,
                                                                                  "puppy_id": data[index].orderDateString,
                                                                                });
                                                                                try{
                                                        ...
                                                        Row(
                                                          children: <Widget>[
                                                            Text(
                                                                "SKU: "+data[index].items[0].stockUnitId
                                                                +"  |  Qty: " + data[index].items[0].quantity,
                                                                style: TextStyle(
                                                                    fontFamily:
                                                                    'NunitoSans',
                                                                    fontSize:
                                                        ...
                                                        Row(
                                                          children: <Widget>[
                                                            Text(
                                                                "\$ " +
                                                                    double.parse(data[index].items[0].cost.toString()).toString(),
                                                                style: TextStyle(
                                                                    fontFamily:
                                                                    'NunitoSans',
                                                                    fontSize:
